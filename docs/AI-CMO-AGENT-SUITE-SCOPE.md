...
| Distribution — Instagram | Fully wired: Composio primary, direct Graph fallback, DMs, comments, publish | `lib/instagram-graph.ts`, `lib/instagram-composio.ts`, `lib/claw/fallback.ts` |
