...
- Identical strategy ≥2 failures with no new evidence is LOOP_DETECTED: do not retry that action. Take a materially different action (different tool, different arguments, aion_consult, or execution_blocked).
...
Aion-Brain is the connected brain. Use aion_status / aion_consult / aion_n8n when you need its lattice, memory, or n8n. Treat Aion output as advice, never as proof an action ran.
