...
3. The operator's own inbox ("check my DMs", "read messages", "what's in my inbox"): ig_list_conversations / ig_get_messages / ig_send_dm. This is the one that's usually gated (instagram_manage_messages + INSTAGRAM_MCP_DM_ENABLED=1, Meta 24h reply window) — only touch these when the operator's own words say DMs, messages, or inbox, never for job 1 or 2 above.
