...
/**
 * 21st.dev Sidebar (manuarora700 / Aceternity)
 * Registry: https://21st.dev/r/manuarora700/sidebar
 * Used for Grok-style agent / conversation chrome.
 */
...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        "hidden h-full w-[260px] flex-shrink-0 flex-col bg-neutral-50 px-3 py-4 dark:bg-neutral-950 md:flex",
        className,
      )}
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className="flex h-10 w-full flex-row items-center justify-between bg-neutral-50 px-4 py-4 dark:bg-neutral-950 md:hidden"
        {...props}
      >
