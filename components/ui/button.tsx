...
const buttonVariants = cva(
  "inline-flex max-w-full min-w-0 items-center justify-center overflow-hidden text-ellipsis whitespace-nowrap rounded-md border text-xs font-semibold tracking-[0.01em] transition-all duration-200 disabled:pointer-events-none disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--claw-accent))]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background active:translate-y-px",
  { variants: { variant: {
    ...
    outline: "border-border bg-transparent text-foreground hover:border-[hsl(var(--claw-accent))]/40 hover:bg-[hsl(var(--claw-accent))]/5",
    danger: "border-[hsl(var(--danger))]/30 bg-[hsl(var(--danger))]/10 text-[hsl(var(--danger))] hover:bg-[hsl(var(--danger))]/20",
