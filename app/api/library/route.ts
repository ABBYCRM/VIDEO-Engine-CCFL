...
export async function GET(){
  ...
  const assets=[...generated,...avatarAssets,...videos,...compositions].sort((a,b)=>new Date(b.createdAt||0).getTime()-new Date(a.createdAt||0).getTime());return NextResponse.json({assets});
}
